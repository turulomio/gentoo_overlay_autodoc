...
def get_description(subdirs):
        for currentpath, folders, files in walk(subdirs):
            for file in files:
...
"""
    ...
    for o in twodirs:
        url=get_url(args.directory + sep + o)
        s=s + """## <a href="{1}"><img src="https://raw.githubusercontent.com/turulomio/gentoo_overlay_autodoc/master/gentoo_overlay_autodoc/images/home.png" style="vertical-align:middle;" width="5%" /></a>    <a href="https://github.com/turulomio/myportage/tree/master/{0}">{0}</a>\n\n""".format(o,url)
        s=s + get_description(args.directory+ sep + o) + "\n\n"
    
    s=s+"<p style='text-align: right;'>" + _("""This page has been autogenerated with <a href="https://github.com/turulomio/gentoo_overlay_autodoc">Gentoo Overlay Autodoc</a>""") + "</p>\n"
