...
"""
    ...
    for o in twodirs:
        s=s + """## <img src="https://raw.githubusercontent.com/turulomio/gentoo_overlay_autodoc/master/gentoo_overlay_autodoc/images/directory.png" alt="centered image" width="5%" /> <a href="https://github.com/turulomio/myportage/tree/master/{0}">{0}</a> \n\n""".format(o)
